...
AddCSLuaFile("vgui/hr.lua")
AddCSLuaFile("vgui/scoreboard.lua")
AddCSLuaFile("vgui/scoreboard_classic.lua")
...
AddCSLuaFile("vgui/options_nightvision.lua")
...
if SERVER then
    ...
    include("vgui/scoreboard_classic.lua")
    ...
    include("vgui/options_nightvision.lua")
